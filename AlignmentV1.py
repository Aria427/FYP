...
#pdb.set_trace()
#genome = readGenome('HumanGenome.fa.gz')
#reads = readSequence('HumanSequencingReads.tsv.bz2')
genome = readGenome('PhiXGenome.fa')
reads = readSequence('PhiXSequencingReads1000.fastq')
