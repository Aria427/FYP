...
#This function analyses the MapReduce output files.        
def analyseMR(mapReduceResultFiles):        
    ...
    mostMatches = countOffsetDict[maxCount]    
    print 'The sequencing reads matched the most at offset %d.' % mostMatches
